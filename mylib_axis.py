...
def CreateLonAxisTicks(axisxticknb, textprop):
    ...
    for i in range(int(axisxticknb)):
        ...
        listlonaxistickuactors.append(
            CreateAxisTickActor(0, 0, 0, axisxticksize, colorfg))
        listlonaxistickdactors.append(
            CreateAxisTickActor(0, 0, 0, axisxticksize, colorfg))
...
def CreateLatAxisTicks(axisyticknb, textprop):
    ...
    for i in range(int(axisyticknb)):
        ...
        listlataxistickractors.append(
            CreateAxisTickActor(0, 0, axisyticksize, 0, colorfg))
        listlataxisticklactors.append(
            CreateAxisTickActor(0, 0, axisyticksize, 0, colorfg))
